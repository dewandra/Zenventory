<div class="flex h-full flex-col space-y-4">
    ...
    <div class="flex-shrink-0 rounded-lg bg-white p-6 shadow-md">
        <x-page-header title="Manajemen Produk">
            <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari berdasarkan Nama atau SKU..." class="w-full sm:w-64 px-4 py-2 border rounded-md shadow-sm">
            @can('manage products')
    ...
    <div class="flex flex-1 flex-col rounded-lg bg-white p-6 shadow-md">
        ...
        {{-- PERBAIKAN PADA TABEL INI --}}
        <div class="flex-grow overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    {{-- Sederhanakan kolom tabel --}}
                    <tr>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    {{-- Hapus data placeholder dan gunakan data asli --}}
