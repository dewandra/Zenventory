    ...
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            ...
            <div class="flex items-center space-x-4">
                <input type="text" wire:model.debounce.300ms="search" placeholder="Cari produk..." class="w-full sm:w-64 px-4 py-2 border rounded-md shadow-sm">
                @can('manage products')
                {{-- Tombol ini sekarang mengirim event Alpine.js --}}
                <button x-data @click="$dispatch('open-modal', 'product-form')" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg whitespace-nowrap">
                    Tambah Produk
                </button>
                @endcan
            </div>
