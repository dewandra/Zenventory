<div class="space-y-6">
    <div class="bg-white p-6 shadow-md rounded-lg">
        <x-page-header title="Inventory Stock Summary">
            <div class="flex items-center space-x-4">
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search Product..." class="w-full sm:w-80 px-4 py-2 border rounded-md">
    ...
    <div class="grid grid-cols-1 @if($selectedProductId) lg:grid-cols-2 @endif gap-6">
        <div class="bg-white p-6 shadow-md rounded-lg flex flex-col">
             <h3 class="font-bold text-xl mb-4 text-gray-800">Stock per Product</h3>
            <div class="flex-grow overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="px-6 py-4 text-center text-gray-500">No stock found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        @if ($selectedProductId)
            <div class="bg-white p-6 shadow-md rounded-lg flex flex-col animate-fade-in-down">
                 <div class="flex justify-between items-center mb-4">
                    <h3 class="font-bold text-xl text-gray-800">Batch Details for: <span class="text-blue-600">{{ $selectedProductName }}</span></h3>
                ...
                <div class="flex-grow overflow-y-auto max-h-96">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-4 text-center text-gray-500">No batches found for this product.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
